...
//TODO improve value mapping !!
	/*
willie@willie-p6651at:~/work/redis-2.8.4$ ./src/redis-cli 
127.0.0.1:6379> hget perm:1 created
...
127.0.0.1:6379> hget perm:1 text
"\xac\xed\x00\x05t\x00\x0cpermission 1"
127.0.0.1:6379> 
	...
	public PermissionRedisRepository(StringRedisTemplate template) {
		...
		//this.template.setHashValueSerializer(new OxmSerializer(new CastorMarshaller(), new CastorMarshaller()));
